...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`p-4 fixed z-50 w-full text-white gap-4 shadow-xl ${navOpen ? "h-full" : ""}`} style={{ backgroundColor: "#231139" }}>
        <div className="flex items-center justify-between lg:w-2/3 lg:mx-auto h-[50px]">
          {/* Brand */}
